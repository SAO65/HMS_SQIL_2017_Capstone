...
plot(density(df.sust.EU$QUALITYe), main="Sustainable Quality", col="blue", lty=3, axes=F, lwd=2, xlab="QUALITYe, COSTe", ylab = "Frequency", ylim=c(0,3), xlim=c(0,2.5))

lines(density(df.sust.EU$COSTe), col="red", lty=3, lwd=2)
...
abline(v=df.sust.EU$QUALITYe[df.sust.EU$Country == ID.EU], lty=1, col="blue", lwd=1)

abline(v=df.sust.EU$COSTe[df.sust.EU$Country == ID.EU], lty=1, col="red", lwd=1)

abline(v=1, lty=1, col="black",  lwd=1)

...
plot(df.EU.1990$yld, df.EU.1990$the, xlab="Years Lived with Disease", ylab="Per Capita Total Health Expenditure", col="blue", pch = 16, cex = 1.3, lty = "solid", lwd = 2, xlim=c(8, 15), ylim=c(100, 8500), axes=FALSE, frame.plot=FALSE)
...
legend(7.8, 7000, c("EU 1990","EU 2010","USA 1990", "USA 2010", "JPN 2010"), col=c("blue", "red", "black", "black", "black"), bty="n", y.intersp=1.5, pch=c(16,16, 5, 9, 8), cex = 1)

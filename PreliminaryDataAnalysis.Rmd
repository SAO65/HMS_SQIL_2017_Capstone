...
legend(30, 15, c("EU 1990","EU 2010","JPN 2010"), col=c("blue", "red", "black"), bty="n", y.intersp=1.5, pch=c(16,16,16,16), cex = 1)
...
legend(7.8, 7000, c("EU 1990","EU 2010","JPN 2010"), col=c("blue", "red", "black"), bty="n", y.intersp=1.5, pch=c(16,16,16,16), cex = 1)
...
LE <- function(HALE, YLD, alfa, beta) HALE^alfa * YLD^beta
LE(HALE, YLD, alfa, beta)

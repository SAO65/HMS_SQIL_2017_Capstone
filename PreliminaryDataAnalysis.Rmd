...
plot(df.EU$the.2010 , QUALITY.EU.2010, col="red", pch = 16, cex = 1.3, lty = "solid", lwd = 2,ylim=c(.82,.9))
points(df.EU$the.1990, QUALITY.EU.1990, col="blue", pch = 16, cex = 1.3, lty = "solid", lwd = 2)

fun.EU.1990 <- lm(QUALITY.EU.1990 ~ df.EU$the.1990)
fun.EU.2010 <- lm(QUALITY.EU.2010 ~ df.EU$the.2010)

abline(fun.EU.1990, lty = 6, col="blue", lwd=2)
